...
const Home = () => {
  return (
    <div>
      ...
      text-white justify-between flex-wrap'>
        ...
        <div className='mx-3 my-12 bg-gradient-to-r from-richblack-900 to-richblack-200 shadow-blue-200'>
            <video
            muted
            loop
            autoPlay
            ...
            <CodeBlocks   
                ...
                heading={
                    <div className='text-4xl font-semibold '>
                        Unlock Your
                        <HighlightText text={"coding potential"} className=""/>
      ...
      <div className='bg-pure-greys-5 text ring-richblack-700'>
